...
export const Footer = () => {
  ...
  return (
    <footer className="text-gray-500 px-4 py-5 mx-auto md:px-8">
            <div className="gap-6 justify-between md:flex text-white">
                <div className="flex-1">
                    ...
                    >
                        ...
                        <div className="max-w-sm flex items-center border rounded-md p-1">
                            ...
                            />
                            <button
                                className="p-2.5 rounded-md text-white bg-red-800 outline-none shadow-md focus:shadow-none sm:px-5"
                            >
                                Subscribe
                            </button>
                        </div>
